...
import org.herokuapp.Pages.DragAndDropPage;
...
public class DragAndDropTests {
    ...
    public void TC01_DragAndDropFromSrcToDest(){
        ...
        Assert.assertTrue(dragAndDropPage.srcHeader.getText().contains("B"), "BUG : There is some issue with" +
                " Drag and Drop");
    }
    @Test
    public void TC02_DragAndDropFromDestToSrc(){
        ...
        Assert.assertTrue(dragAndDropPage.destHeader.getText().contains("A"),"BUG : There is some issue with" +
                " Drag and Drop");
    }
}
